...
- **HANDOFF.md** — reflects the current state (80 tools, 64 C++ handlers + 16 bridge synthetic, all directives, all traps)
...
- **80 tools shipped** (64 UE C++ handlers + 16 bridge-side synthetic)
