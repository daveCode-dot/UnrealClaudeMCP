...
- **HANDOFF.md** — reflects the current state (92 tools, 71 C++ handlers + 21 bridge synthetic, all directives, all traps)
...
- **92 tools shipped** (71 UE C++ handlers + 21 bridge-side synthetic)
