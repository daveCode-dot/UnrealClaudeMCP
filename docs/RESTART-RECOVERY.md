...
- **HANDOFF.md** — reflects the current state (77 tools, 64 C++ handlers + 13 bridge synthetic, all directives, all traps)
...
- **77 tools shipped** (64 UE C++ handlers + 13 bridge-side synthetic)
