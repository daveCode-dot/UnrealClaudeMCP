...
- **HANDOFF.md** — reflects the current state (69 tools, 64 C++ handlers + 5 bridge synthetic, all directives, all traps)
...
- **69 tools shipped** (64 UE C++ handlers + 5 bridge-side synthetic)
