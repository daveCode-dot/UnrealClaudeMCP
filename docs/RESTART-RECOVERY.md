...
- **HANDOFF.md** — reflects the current state (70 tools, 64 C++ handlers + 6 bridge synthetic, all directives, all traps)
...
- **70 tools shipped** (64 UE C++ handlers + 6 bridge-side synthetic)
