...
- **HANDOFF.md** — reflects the current state (78 tools, 64 C++ handlers + 14 bridge synthetic, all directives, all traps)
...
- **78 tools shipped** (64 UE C++ handlers + 14 bridge-side synthetic)
