...
- **HANDOFF.md** — reflects the current state (74 tools, 64 C++ handlers + 10 bridge synthetic, all directives, all traps)
...
- **74 tools shipped** (64 UE C++ handlers + 10 bridge-side synthetic)
