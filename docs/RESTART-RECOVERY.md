...
- **HANDOFF.md** — reflects the current state (79 tools, 64 C++ handlers + 15 bridge synthetic, all directives, all traps)
...
- **79 tools shipped** (64 UE C++ handlers + 15 bridge-side synthetic)
