...
- **HANDOFF.md** — reflects the current state (72 tools, 64 C++ handlers + 8 bridge synthetic, all directives, all traps)
...
- **72 tools shipped** (64 UE C++ handlers + 8 bridge-side synthetic)
