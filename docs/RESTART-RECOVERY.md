...
- **HANDOFF.md** — reflects the current state (96 tools, 71 C++ handlers + 25 bridge synthetic, all directives, all traps)
...
- **96 tools shipped** (71 UE C++ handlers + 25 bridge-side synthetic)
