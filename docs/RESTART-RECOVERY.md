...
- **HANDOFF.md** — reflects the current state (71 tools, 64 C++ handlers + 7 bridge synthetic, all directives, all traps)
...
- **71 tools shipped** (64 UE C++ handlers + 7 bridge-side synthetic)
