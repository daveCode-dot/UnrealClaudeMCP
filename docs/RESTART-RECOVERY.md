...
- **HANDOFF.md** — reflects the current state (100 tools, 71 C++ handlers + 29 bridge synthetic, all directives, all traps)
...
- **100 tools shipped** (71 UE C++ handlers + 29 bridge-side synthetic)
