...
- **HANDOFF.md** — reflects the current state (88 tools, 71 C++ handlers + 17 bridge synthetic, all directives, all traps)
...
- **88 tools shipped** (71 UE C++ handlers + 17 bridge-side synthetic)
